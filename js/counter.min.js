                ...
                value: function() {
                    ...
                    t.onreadystatechange = function() {
                        if (4 === t.readyState && 200 === t.status) {
                            ...
                            if (null !== e.element.getAttribute("counter-status")) return void(e.element.innerHTML = n.status ? '<span style="color:lightgreen;">online</span>' : '<span style="color:red;">offline</span>');
                            if (n.status) {
